...
class SupportTicketAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('user', 'subject', 'category', 'priority', 'status', 'assigned_to', 'created_at', 'updated_at')
    fields = (
...
class SupportMessageAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('ticket', 'sender', 'message', 'is_internal_note', 'created_at')
    fields = (
        'ticket', 'sender', 'message', 'is_internal_note',
    )
