...
class NotificationAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('user', 'notification_type', 'title', 'message', 'is_read', 'link', 'created_at')
    fields = (
...
class MessageAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('sender', 'recipient', 'subject', 'body', 'message_type', 'is_read', 'created_at')
    fields = (
        'sender', 'recipient', 'subject', 'body', 'message_type',
        'is_read',
    )
