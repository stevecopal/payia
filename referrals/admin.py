...
class ReferralAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('referrer', 'referred_user', 'referral_level', 'is_active', 'created_at')
    fields = (
        'referrer', 'referred_user', 'referral_level', 'is_active',
    )
...
class CommissionAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('user', 'source_user', 'referral_level', 'percentage', 'gross_revenue', 'amount', 'status', 'created_at', 'updated_at')
    fields = (
        'user', 'source_user', 'referral_level', 'percentage',
        'gross_revenue', 'amount', 'status',
    )
